# flake8: noqa
"""
Django settings for relayz_cookwag_project project.
...
DJANGO_ROOT = root.path('relayz_cookwag_project')
...
ROOT_URLCONF = 'relayz_cookwag_project.urls'

#Admins see https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = (
    ("""Matt Rosenberg""", 'matt4coding@gmail.com'),
)
...
WSGI_APPLICATION = 'relayz_cookwag_project.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///relayz_cookwag_project'),
}
...
WAGTAIL_SITE_NAME = "relayz_cookWag_project"
